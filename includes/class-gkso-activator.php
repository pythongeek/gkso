...
class GKSO_Activator {
    ...
    public static function activate() {
        ...
        // Create internal linking index table
        GKSO_Internal_Linking::create_table();
    ...
    private static function add_capabilities() {
        ...
        // Also add to editor role for viewing
    ...
    private static function create_database_index() {
        ...
        // Suppress errors during index creation – table may already be indexed
        // NOTE: MySQL does NOT support partial/filtered indexes (the WHERE clause).
        // We create a standard composite index on (meta_key, meta_value) instead.
        ...
        if ( ! $index_exists ) {
            // Standard composite index – no WHERE clause (unsupported in MySQL/MariaDB)
